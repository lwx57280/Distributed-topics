 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webservice.com/", wsdlLocation = "http://localhost:8888/vip/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webservice.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webservice.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
